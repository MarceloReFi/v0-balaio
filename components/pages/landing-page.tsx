...
export function LandingPage({ onConnect, language }: LandingPageProps) {
  ...
  return (
    <div className="pb-8">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#2B325C] via-[#3A4571] to-[#636D4F] border-b-2 border-black p-6 md:p-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            onClick={onConnect}
            className="bg-[#FFF244] text-black px-8 py-4 font-bold text-lg border-2 border-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-shadow"
          >
            {t.connectWallet}
          </button>
        </div>
      ...
      <section className="p-6 md:p-10 bg-[#F5F1E8]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white border-2 border-black p-6 mb-6">
            ...
            <ul className="space-y-3 text-sm md:text-base">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-[#636D4F] flex-shrink-0 mt-0.5" />
                <span>
                  {language === "en"
          ...
          {/* Micro-work Benefits */}
          <div className="bg-[#636D4F] border-2 border-black p-6 text-white">
      ...
      <section className="p-6 md:p-10 bg-white border-y-2 border-black">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Freelancer CTA */}
            <div className="bg-[#F5F1E8] border-2 border-black p-6">
              <div className="flex items-center gap-3 mb-4">
                <Users className="w-8 h-8 text-[#2B325C]" />
              ...
              <button
                onClick={onConnect}
                className="w-full bg-[#2B325C] text-white px-4 py-3 font-bold text-sm border-2 border-black hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-shadow flex items-center justify-center gap-2"
              >
            ...
            <div className="bg-[#F5F1E8] border-2 border-black p-6">
              <div className="flex items-center gap-3 mb-4">
                <Building2 className="w-8 h-8 text-[#2B325C]" />
              ...
              <a
                ...
                className="w-full bg-[#D96E5F] text-white px-4 py-3 font-bold text-sm border-2 border-black hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-shadow flex items-center justify-center gap-2"
              >
      ...
      <section className="p-6 md:p-10 bg-[#F5F1E8]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border-2 border-black p-6">
              <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
                <Users className="w-5 h-5 text-[#636D4F]" />
                {language === "en" ? "For Contributors" : "Para Colaboradores"}
              </h3>
              <ol className="space-y-4">
                <li className="flex gap-3">
                  <span className="bg-[#FFF244] border-2 border-black w-7 h-7 flex items-center justify-center font-bold text-sm flex-shrink-0">1</span>
                  <div>
                    <span className="font-bold text-sm">{language === "en" ? "Sign up:" : "Cadastre-se:"}</span>
                    <p className="text-xs text-gray-600">{language === "en" ? "Connect your wallet." : "Conecte sua carteira."}</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="bg-[#FFF244] border-2 border-black w-7 h-7 flex items-center justify-center font-bold text-sm flex-shrink-0">2</span>
                  <div>
                    <span className="font-bold text-sm">{language === "en" ? "Choose tasks:" : "Escolha tarefas:"}</span>
                    <p className="text-xs text-gray-600">{language === "en" ? "Filter by type, reward, or location." : "Filtre por tipo, recompensa ou localização."}</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="bg-[#FFF244] border-2 border-black w-7 h-7 flex items-center justify-center font-bold text-sm flex-shrink-0">3</span>
                  <div>
                    <span className="font-bold text-sm">{language === "en" ? "Submit and get paid:" : "Envie e seja pago:"}</span>
                    <p className="text-xs text-gray-600">{language === "en" ? "Complete the task, submit proof, and receive onchain payment once approved." : "Complete a tarefa, envie prova e receba pagamento onchain após aprovação."}</p>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div className="bg-white border-2 border-black p-6">
              <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
                <Building2 className="w-5 h-5 text-[#636D4F]" />
                {language === "en" ? "For Organizations" : "Para Organizações"}
              </h3>
              <ol className="space-y-4">
                <li className="flex gap-3">
                  <span className="bg-[#C36DF0] border-2 border-black w-7 h-7 flex items-center justify-center font-bold text-sm text-white flex-shrink-0">1</span>
                  <div>
                    <span className="font-bold text-sm">{language === "en" ? "Design tasks:" : "Crie tarefas:"}</span>
                    <p className="text-xs text-gray-600">{language === "en" ? "Define what needs to be done and how much you'll pay." : "Defina o que precisa ser feito e quanto você pagará."}</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="bg-[#C36DF0] border-2 border-black w-7 h-7 flex items-center justify-center font-bold text-sm text-white flex-shrink-0">2</span>
                  <div>
                    <span className="font-bold text-sm">{language === "en" ? "Publish to Balaio:" : "Publique no Balaio:"}</span>
                    <p className="text-xs text-gray-600">{language === "en" ? "Your tasks appear to contributors." : "Suas tarefas aparecem para colaboradores."}</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="bg-[#C36DF0] border-2 border-black w-7 h-7 flex items-center justify-center font-bold text-sm text-white flex-shrink-0">3</span>
                  <div>
                    <span className="font-bold text-sm">{language === "en" ? "Approve and pay:" : "Aprove e pague:"}</span>
                    <p className="text-xs text-gray-600">{language === "en" ? "Review submissions and trigger on-chain payouts in one click." : "Revise envios e acione pagamentos onchain em um clique."}</p>
                  </div>
                </li>
              </ol>
            </div>
          ...
          <div className="mt-6 text-center">
            <button
              onClick={onConnect}
              className="bg-[#FFF244] text-black px-8 py-3 font-bold border-2 border-black hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-shadow inline-flex items-center gap-2"
            >
      ...
      {/* Why Onchain Section */}
      <section className="p-6 md:p-10 bg-[#2B325C] border-y-2 border-black">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/10 border-2 border-white/30 p-5">
              <div className="flex items-center gap-3 mb-2">
                <Zap className="w-6 h-6 text-[#FFF244]" />
            ...
            <div className="bg-white/10 border-2 border-white/30 p-5">
              <div className="flex items-center gap-3 mb-2">
                <Globe className="w-6 h-6 text-[#FFF244]" />
            ...
            <div className="bg-white/10 border-2 border-white/30 p-5">
              <div className="flex items-center gap-3 mb-2">
                <Shield className="w-6 h-6 text-[#FFF244]" />
            ...
            <div className="bg-white/10 border-2 border-white/30 p-5">
              <div className="flex items-center gap-3 mb-2">
                <CheckCircle className="w-6 h-6 text-[#FFF244]" />
      ...
      <section className="p-6 md:p-10 bg-[#F5F1E8]">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-2 justify-center">
            <Building2 className="w-7 h-7 text-[#2B325C]" />
          ...
          <div className="bg-white border-2 border-black p-6 mb-6">
            ...
            <ul className="space-y-2 text-sm mb-6">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#636D4F] flex-shrink-0 mt-0.5" />
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-[#C36DF0] text-white px-3 py-1 text-xs font-bold border-2 border-black">
                {language === "en" ? "Web3 ecosystem growth" : "Crescimento de ecossistemas Web3"}
              </span>
              <span className="bg-[#636D4F] text-white px-3 py-1 text-xs font-bold border-2 border-black">
                {language === "en" ? "Local research" : "Pesquisa local"}
              </span>
              <span className="bg-[#D96E5F] text-white px-3 py-1 text-xs font-bold border-2 border-black">
                {language === "en" ? "Education & onboarding" : "Educação & onboarding"}
              </span>
              <span className="bg-[#2B325C] text-white px-3 py-1 text-xs font-bold border-2 border-black">
          ...
          <div className="text-center">
            <a
              href="mailto:talkbalaio@gmail.com"
              className="bg-[#D96E5F] text-white px-6 py-3 font-bold border-2 border-black hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-shadow inline-flex items-center gap-2"
            >
      ...
      <section className="p-6 md:p-10 bg-white border-y-2 border-black">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-2 justify-center">
            <Users className="w-7 h-7 text-[#636D4F]" />
            <h2 className="text-2xl font-bold">
              {language === "en" ? "For Contributors" : "Para Colaboradores"}
            </h2>
          </div>
          ...
          <div className="bg-[#F5F1E8] border-2 border-black p-6 mb-6">
            <p className="text-sm md:text-base mb-6">
              {language === "en"
            ...
            <h4 className="font-bold mb-4">{language === "en" ? "Why people use Balaio:" : "Por que as pessoas usam o Balaio:"}</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white border-2 border-black p-4">
                <h5 className="font-bold text-sm mb-1 flex items-center gap-2">
                  <Wallet className="w-4 h-4 text-[#636D4F]" />
              ...
              <div className="bg-white border-2 border-black p-4">
                <h5 className="font-bold text-sm mb-1 flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-[#636D4F]" />
              ...
              <div className="bg-white border-2 border-black p-4">
                <h5 className="font-bold text-sm mb-1 flex items-center gap-2">
                  <Zap className="w-4 h-4 text-[#636D4F]" />
              ...
              <div className="bg-white border-2 border-black p-4">
                <h5 className="font-bold text-sm mb-1 flex items-center gap-2">
                  <Smartphone className="w-4 h-4 text-[#636D4F]" />
          ...
          <div className="text-center">
            <button
              onClick={onConnect}
              className="bg-[#636D4F] text-white px-6 py-3 font-bold border-2 border-black hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-shadow inline-flex items-center gap-2"
            >
              <Wallet className="w-5 h-5" />
      ...
      <section className="p-6 md:p-10 bg-[#636D4F]">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-2 justify-center">
          ...
          <div className="text-center">
            <a
              href="mailto:talkbalaio@gmail.com"
              className="bg-[#FFF244] text-black px-6 py-3 font-bold border-2 border-black hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-shadow inline-flex items-center gap-2"
            >
      ...
      {/* Final CTA */}
      <section className="p-6 md:p-10 bg-gradient-to-r from-[#2B325C] to-[#636D4F] border-t-2 border-black">
        <div className="max-w-4xl mx-auto text-center">
          <img src="/logo.png" alt="Balaio" className="w-20 h-20 mx-auto mb-4 border-2 border-black bg-white p-2" />
