...
import { recordWalletConnection, recordGoodIDVerification } from "@/lib/wallet/wallet-connections"
import { taskStatusLabel } from "@/lib/tasks/task-status"
import { checkLocationEligibility } from "@/lib/tasks/geo"
        ...
        {connectionMode === "none" && currentPage !== "agents" && (
          <>
            <div className="flex items-center gap-2 justify-center mb-4">
              ...
              >
                <img src="/celo.png" alt="Celo" className="h-4 w-auto object-contain" />
                Celo
              </button>
              <button
                onClick={() => switchChain({ chainId: gnosis.id })}
